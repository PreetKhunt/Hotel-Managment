...
const rooms = [
  // STANDARD (4)
  {
    name: 'Classic Standard Room', type: 'Standard', price: 6500, capacity: 2, size: 280,
  ...
  {
    name: 'City View Standard', type: 'Standard', price: 7200, capacity: 2, size: 300,
  ...
  {
    name: 'Standard Twin Room', type: 'Standard', price: 6500, capacity: 2, size: 320,
  ...
  {
    name: 'Superior Standard', type: 'Standard', price: 8500, capacity: 2, size: 340,
  ...
  // DELUXE (5)
  {
    name: 'Deluxe City View', type: 'Deluxe', price: 10500, capacity: 2, size: 400,
  ...
  {
    name: 'Deluxe Ocean View', type: 'Deluxe', price: 12500, capacity: 2, size: 420,
  ...
  {
    name: 'Deluxe Garden Terrace', type: 'Deluxe', price: 11000, capacity: 2, size: 450,
  ...
  {
    name: 'Grand Deluxe Double', type: 'Deluxe', price: 11500, capacity: 4, size: 480,
  ...
  {
    name: 'Corner Deluxe Room', type: 'Deluxe', price: 13000, capacity: 2, size: 500,
  ...
  // PREMIUM DELUXE (3)
  {
    name: 'Premium Horizon Deluxe', type: 'Premium', price: 16000, capacity: 2, size: 550,
  ...
  {
    name: 'Premium Spa Deluxe', type: 'Premium', price: 18500, capacity: 2, size: 580,
  ...
  {
    name: 'Premium Club Room', type: 'Premium', price: 17000, capacity: 2, size: 520,
  ...
  // EXECUTIVE ROOM (2)
  {
    name: 'Executive City Suite', type: 'Executive', price: 21000, capacity: 2, size: 650,
  ...
  {
    name: 'Executive Studio', type: 'Executive', price: 19500, capacity: 2, size: 600,
  ...
  // FAMILY SUITE (3)
  {
    name: 'Grand Family Suite', type: 'Suite', price: 26000, capacity: 5, size: 850,
  ...
  {
    name: 'Family Ocean Suite', type: 'Suite', price: 29000, capacity: 4, size: 800,
  ...
  {
    name: 'Royal Family Suite', type: 'Suite', price: 34000, capacity: 6, size: 1100,
  ...
  // JUNIOR SUITE (2)
  {
    name: 'Junior Garden Suite', type: 'Suite', price: 24000, capacity: 3, size: 700,
  ...
  {
    name: 'Junior Skyline Suite', type: 'Suite', price: 26500, capacity: 3, size: 720,
  ...
  {
    name: 'The Presidential Suite', type: 'Suite', price: 55000, capacity: 4, size: 1800,
  ...
  {
    name: 'The Royal Suite', type: 'Suite', price: 65000, capacity: 4, size: 2100,
  ...
  // HONEYMOON SUITE (1)
  {
    name: 'Romantic Honeymoon Suite', type: 'Suite', price: 32000, capacity: 2, size: 850,
  ...
  // PRIVATE VILLA (1)
  {
    name: 'Exclusive Beachfront Villa', type: 'Villa', price: 85000, capacity: 6, size: 2800,
  ...
  // PENTHOUSE SUITE (1)
  {
    name: 'The Crown Penthouse', type: 'Penthouse', price: 95000, capacity: 4, size: 3200,
