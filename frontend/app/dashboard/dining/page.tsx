      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem', marginTop: '0.2rem' }}>
            {user?.role?.name === 'Admin' ? 'Manage all restaurant table bookings.' : 'View your restaurant table bookings.'}
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ position: 'relative', flex: '1 1 200px' }}>
          ...
          <input
            ...
            placeholder={user?.role?.name === 'Admin' ? "Search by guest name, email or date..." : "Search by date..."}
            style={{
