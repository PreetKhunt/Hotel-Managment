    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ background: "#0A0F1E" }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p style={{ color: "#94A3B8" }}>Sign in to access your luxury experience.</p>
        </div>
        ...
        <div className="rounded-2xl p-8 border"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs transition-colors" style={{ color: "#C9A84C" }}>
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="mt-6 text-center text-sm" style={{ color: "#94A3B8" }}>
            ...
            <Link href="/register" className="font-medium hover:underline transition-all" style={{ color: "#C9A84C" }}>
              Sign up
            </Link>
          </p>
        </div>
