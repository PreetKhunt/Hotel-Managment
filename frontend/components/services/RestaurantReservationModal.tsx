...
export default function RestaurantReservationModal({ isOpen, onClose }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/restaurant/reserve', {
        date,
        time,
        guests,
      ...
      toast.error(err.response?.data?.message || 'Failed to reserve table. Please log in.');
    } finally {
        ...
        >
          ...
          >
            ...
            <div style={{ padding: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h3 style={{ color: '#fff', fontSize: '1.25rem', fontWeight: 600 }}>Reserve a Table</h3>
              <button
                onClick={onClose}
